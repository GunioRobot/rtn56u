	...
	<tr>
	  ...
	  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable">
        ...
        <tr>
          ...
          <td>
            <input type="password" name="http_passwd2" onClick="openHint(11,4)" onKeyPress="return is_string(this);" class="input" size="19" maxlength="16" />
          </td>
        </tr>
        <tr>
          <th valign="top"><a class="hintstyle"  href="javascript:void(0);" onClick="openHint(11,4)"><#PASS_retype#></th>
          <td>
            <input type="password" name="v_password2" onClick="openHint(11,4)" onKeyPress="return is_string(this);" class="input" size="19" maxlength="16" /><br/><span id="alert_msg"></span>
          </td>
        </tr>
      </table>
	</td>
